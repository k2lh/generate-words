        ...
        return this.each(function() {
                ...
                function selectStep(idx){
                    if(idx < steps.length && idx >= 0){
                      ...
                      applyCSS($(selStepAnchor, obj),"current");
                ...
                function applyCSS(elm,css){
                    $(elm, obj).removeClass("default");
                    $(elm, obj).removeClass("current");
                    $(elm, obj).removeClass("done");
